...
struct NemoLocalTrashDirectoryDetails {
	NemoQuery *query;
...
typedef struct {
	NemoLocalTrashDirectory *search_directory;
...
G_DEFINE_TYPE (NemoLocalTrashDirectory, nemo_local_trash_directory,
	       NEMO_TYPE_DIRECTORY);

static void search_engine_hits_added (NemoSearchEngine *engine, GList *hits, NemoLocalTrashDirectory *search);
static void search_engine_hits_subtracted (NemoSearchEngine *engine, GList *hits, NemoLocalTrashDirectory *search);
static void search_engine_finished (NemoSearchEngine *engine, NemoLocalTrashDirectory *search);
static void search_engine_error (NemoSearchEngine *engine, const char *error, NemoLocalTrashDirectory *search);
static void search_callback_file_ready_callback (NemoFile *file, gpointer data);
static void file_changed (NemoFile *file, NemoLocalTrashDirectory *search);

static void
ensure_search_engine (NemoLocalTrashDirectory *search)
{
...
static void
reset_file_list (NemoLocalTrashDirectory *search)
{
...
static void
start_or_stop_search_engine (NemoLocalTrashDirectory *search, gboolean adding)
{
...
static void
file_changed (NemoFile *file, NemoLocalTrashDirectory *search)
{
	GList list;
...
static void
search_monitor_remove_file_monitors (SearchMonitor *monitor, NemoLocalTrashDirectory *search)
{
	GList *list;
	NemoFile *file;
...
static void
search_monitor_destroy (SearchMonitor *monitor, NemoLocalTrashDirectory *search)
{
...
search_callback_find (NemoLocalTrashDirectory *search, NemoDirectoryCallback callback, gpointer callback_data)
{
	SearchCallback *search_callback;
	GList *list;
...
static SearchCallback *
search_callback_find_pending (NemoLocalTrashDirectory *search, NemoDirectoryCallback callback, gpointer callback_data)
{
	SearchCallback *search_callback;
	GList *list;
...
static void
search_engine_error (NemoSearchEngine *engine, const char *error_message, NemoLocalTrashDirectory *search)
{
	GError *error;
...
static void
search_engine_finished (NemoSearchEngine *engine, NemoLocalTrashDirectory *search)
{
...
search_dispose (GObject *object)
{
	...
	G_OBJECT_CLASS (nemo_local_trash_directory_parent_class)->dispose (object);
}
...
search_finalize (GObject *object)
{
	...
	G_OBJECT_CLASS (nemo_local_trash_directory_parent_class)->finalize (object);
}
...
static void
nemo_local_trash_directory_class_init (NemoLocalTrashDirectoryClass *class)
{
